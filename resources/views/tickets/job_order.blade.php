...
<body>
    ...
    <table>
        <tr>
            ...
            <td class="value">{{ $ticket->date_submitted ? $ticket->date_submitted->format('F d, Y') : '—' }}</td>
        </tr>

        <tr>
            <td><strong>Status:</strong></td>
            <td class="value">{{ $ticket->status }}</td>
            <td><strong>Date Finished:</strong></td>
            <td class="value">
                {{ $ticket->date_finished ? $ticket->date_finished->format('F d, Y') : '—' }}
            </td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            ...
            <td class="value">{{ $ticket->client_name }}</td>
        </tr>
        <tr>
    ...
    <table>
        <tr>
            ...
            <td class="value">{{ $ticket->assignee->name ?? 'Not Assigned' }}</td>
        </tr>
    </table>
