...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::YTPWxqHYDOXy8UMr',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::6hxyrPZgSwkc7kcT',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::r8VjvAqOUzlaPIDe',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::ZoOC8cHoMbxpZcAJ',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::f4k9yVfDZLNuZev4',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/users/([^/]++)(?|(*:25)|/edit(*:37)|(*:44))|/m(?|is\\-queue/(?|serve/([^/]++)(*:84)|complete/([^/]++)(*:108))|aintenance/([^/]++)(?|/(?|complete(*:151)|edit(*:163)|job\\-order(*:181))|(*:190))|eetings/(?|([^/]++)(*:218)|create(*:232)|([^/]++)(?|/edit(*:256)|(*:264))))|/t(?|ickets/([^/]++)(?|/(?|job\\-order(?|(*:315)|\\-pdf(*:328))|edit(*:341)|comments(*:357))|(*:366))|asks/(?|([^/]++)(*:391)|create(*:405)|([^/]++)(?|/edit(*:429)|(*:437))))|/c(?|o(?|mments/([^/]++)(*:472)|ndemned\\-equipment/([^/]++)(?|/edit(*:515)|(*:523)))|ategories/(?|([^/]++)(*:554)|create(*:568)|([^/]++)(?|/edit(*:592)|(*:600))))|/feedbacks/(?|create/([^/]++)(*:640)|store/([^/]++)(*:662)|([^/]++)(?|/(?|download\\-pdf(*:698)|edit(*:710))|(*:719)))|/departments/([^/]++)(?|(*:753))|/assets/([^/]++)(?|/edit(*:786)|(*:794))|/notifications/([^/]++)/(?|read(*:834)|unread(*:848))|/reset\\-password/([^/]++)(*:882)|/verify\\-email/([^/]++)/([^/]++)(*:922)|/storage/(.*)(*:943))/?$}sDu',
    ),
    3 => 
    array (
      25 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:27:"fn () => \\view(\'dashboard\')";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000008240000000000000000";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'tickets/{ticket}/job-order-pdf',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'feedbacks/{feedback}/download-pdf',
      'action' => 
      array (
        'middleware' => 
        array (
