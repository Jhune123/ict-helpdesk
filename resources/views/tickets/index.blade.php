        ...
        <table class="min-w-full divide-y text-sm">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-3 py-2 hidden">Equipment Type</th> {{-- HIDDEN --}}
                    ...
                    <th class="px-3 py-2 hidden">Contact #: / E-mail Address</th> {{-- HIDDEN --}}
                    <th class="px-3 py-2">Status</th>
                    <th class="px-3 py-2 hidden">Submitted</th> {{-- HIDDEN --}}
                    <th class="px-3 py-2 hidden">Finished</th> {{-- HIDDEN --}}
            ...
            <tbody class="divide-y">
                ...
                ">
                    ...
                    <td class="px-3 py-2 hidden">{{ $ticket->equipment_type ?? '-' }}</td> {{-- HIDDEN --}}
                    ...
                    <td class="px-3 py-2 hidden">{{ $ticket->contact_number ?? '-' }}</td> {{-- HIDDEN --}}
                    <td class="px-3 py-2">{{ $ticket->status }}</td>
                    <td class="px-3 py-2 hidden">{{ $ticket->date_submitted?->format('M d, Y h:i A') }}</td> {{-- HIDDEN --}}
                    <td class="px-3 py-2 hidden">{{ $ticket->date_finished?->format('M d, Y h:i A') ?? '-' }}</td> {{-- HIDDEN --}}
