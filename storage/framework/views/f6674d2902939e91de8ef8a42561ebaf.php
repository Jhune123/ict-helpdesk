...
<div class="min-h-screen flex flex-col items-center justify-start"
    ...
    <div class="text-center mt-10 mb-8">
        ...
        <p class="text-white mt-1 font-semibold">
            <?php echo e(\Carbon\Carbon::now()->format('l, F d, Y')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/icto/Documents/Sites/ict-helpdesk/resources/views/dashboard.blade.php ENDPATH**/ ?>