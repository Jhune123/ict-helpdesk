...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tickets.index')->with('success', "Ticket created ✅ ({$ticketNumber})");
    }
    ...
    /**
     * ✏ Update Ticket & Auto-Archive Condemned
     */
    public function update(Request $request, Ticket $ticket)
    {
        ...
        // 🛡 AUTOMATIC TRANSFER TO CONDEMNED EQUIPMENTS
        if ($validated['status'] === 'Condemned' && $ticket->status !== 'Condemned') {
            try {
                ...
                CondemnedEquipment::create([
                    ...
                    'property_no'    => $ticket->property_no ?? 'PENDING',
                ...
                Log::info("✅ Archived Ticket {$ticket->ticket_number} to Condemned Equipment.");
            } catch (\Exception $e) {
    ...
    {
        return Pdf::loadView('tickets.job_order', compact('ticket'))->setPaper('A4')->download('JobOrder-'.$ticket->ticket_number.'.pdf');
    }
