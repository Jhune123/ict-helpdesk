        ...
        <div class="mb-4">
            ...
            <select name="department" class="w-full border rounded-lg p-2">
                ...
                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($dept->name); ?>" <?php echo e(old('department') == $dept->name ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/icto/Documents/Sites/ict-helpdesk/resources/views/tickets/create.blade.php ENDPATH**/ ?>