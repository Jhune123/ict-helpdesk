...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::maB3s6AmSjHgyXY8',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::B8ZdytqG564igtQU',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      '/mis-queue/pdf/report' => 
      array (
        0 => 
        array (
          0 => 
          array (
            '_route' => 'queues.pdf.report',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::KGyQ4PsLdyZqlETW',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::3p32Gr0JF1fXPE1D',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::yvWEaSQl89Of0t1N',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::rtNtimhFNm2blAcD',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/m(?|is\\-queue/(?|serve/([^/]++)(*:39)|complete/([^/]++)(*:63))|eetings/([^/]++)(?|(*:90)|/edit(*:102)|(*:110))|aintenance/(?|([^/]++)(?|/job\\-order(*:155)|(*:163))|create(*:178)|([^/]++)(?|/(?|complete(*:209)|edit(*:221))|(*:230))))|/t(?|ickets/([^/]++)(?|/(?|job\\-order(*:278)|edit(*:290)|comments(*:306)|attachments(*:325)|feedback(?|(*:344)))|(*:354))|asks/([^/]++)(?|(*:379)|/edit(*:392)|(*:400)))|/c(?|ategories/([^/]++)(?|(*:436)|/edit(*:449)|(*:457))|o(?|ndemned\\-equipment/(?|([^/]++)(*:500)|create(*:514)|([^/]++)(?|/edit(*:538)|(*:546)))|mments/([^/]++)(*:571)))|/departments/([^/]++)(?|(*:605))|/a(?|ssets/(?|([^/]++)(*:636)|create(*:650)|([^/]++)(?|/edit(*:674)|(*:682)))|ttachments/([^/]++)(?|/download(*:723)|(*:731))|ctivity\\-logs/export/([^/]++)(*:769))|/notifications/([^/]++)/(?|read(*:809)|unread(*:823))|/feedbacks/([^/]++)(?|(*:854))|/reset\\-password/([^/]++)(*:888)|/verify\\-email/([^/]++)/([^/]++)(*:928)|/storage/(.*)(*:949))/?$}sDu',
    ),
    3 => 
    array (
      39 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:27:"fn () => \\view(\'dashboard\')";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000000000ab40000000000000000";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\QueueController@pdfReport',
        'controller' => 'App\\Http\\Controllers\\QueueController@pdfReport',
        'namespace' => NULL,
        'prefix' => '/mis-queue',
        'where' => 
        array (
        ),
        'as' => 'queues.pdf.report',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    try {
        \\Illuminate\\Support\\Facades\\Mail::raw(\'Direct SMTP test from KSU ICT Helpdesk.\', function ($msg) {
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:3:{s:4:"disk";s:5:"local";s:6:"config";a:5:{s:6:"driver";s:5:"local";s:4:"root";s:47:"C:\\laragon\\www\\ict-helpdesk\\storage\\app/private";s:5:"serve";b:1;s:5:"throw";b:0;s:6:"report";b:0;}s:12:"isProduction";b:0;}s:8:"function";s:323:"function (\\Illuminate\\Http\\Request $request, string $path) use ($disk, $config, $isProduction) {
                ...
                }";s:5:"scope";s:47:"Illuminate\\Filesystem\\FilesystemServiceProvider";s:4:"this";N;s:4:"self";s:32:"0000000000000a530000000000000000";}}',
        'as' => 'storage.local',
      ),
      'fallback' => false,
      'defaults' => 
