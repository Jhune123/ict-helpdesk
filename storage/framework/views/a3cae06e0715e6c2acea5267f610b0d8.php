...
<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6 mt-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-700 leading-relaxed">
        <div class="space-y-2">
        ...
        <div class="space-y-2">
            <p><strong>👥 Participants:</strong> <?php echo e($meeting->participants ?: 'No participants listed'); ?></p>
