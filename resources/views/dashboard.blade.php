...
<div class="min-h-screen flex flex-col items-center justify-start"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-6 px-6 mb-10 w-full max-w-6xl">
        ...
        <a href="{{ route('maintenance.index') }}"
           class="bg-teal-600 hover:bg-teal-700 text-white font-bold py-6 px-4 rounded-lg shadow-lg text-center transition transform hover:scale-105">
